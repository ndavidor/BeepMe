...
public final class CameraManager {
   ...
   */
  public synchronized void openDriver(Context context, SurfaceView view) throws IOException {
    ...
    if (!initialized) {
      initialized = true;
      configManager.initFromCameraParameters(theCamera, view.getMeasuredWidth(), view.getMeasuredHeight());
