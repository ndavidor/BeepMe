...
public final class QRCodeEncoder {
  ...
  public QRCodeEncoder(Context context, Intent intent, int dimension, boolean useVCard) throws WriterException {
	  init(context, intent, dimension, useVCard);
  }
  
  public QRCodeEncoder(Context context, String data, Bundle bundle, String type, String format, int dimension, boolean useVCard) throws WriterException {
	  Intent intent = new Intent(Intents.Encode.ACTION);
	  intent.putExtra(Intents.Encode.FORMAT, format);
	  intent.putExtra(Intents.Encode.TYPE, type);
	  if(type.equals(Contents.Type.CONTACT) || type.equals(Contents.Type.LOCATION))
  ...
  private void init(Context context, Intent intent, int dimension, boolean useVCard) throws WriterException{
  ...
  private void encodeQRCodeContents(Intent intent, String type) {
    if (type.equals(Contents.Type.TEXT)) {
      ...
      if (data != null) {
        ...
        displayContents = data;
        title = context.getString(R.string.contents_email);
      }
      ...
      if (data != null) {
        ...
        title = context.getString(R.string.contents_phone);
      }
      ...
      if (data != null) {
        contents = "sms:" + data;
        displayContents = PhoneNumberUtils.formatNumber(data);
        title = context.getString(R.string.contents_sms);
      }
      ...
      if (bundle != null) {
        ...
        if (encoded[1].length() > 0) {
          ...
          title = context.getString(R.string.contents_contact);
        }
      ...
      if (bundle != null) {
        ...
        if (latitude != Float.MAX_VALUE && longitude != Float.MAX_VALUE) {
          ...
          title = context.getString(R.string.contents_location);
        }
      }
    }
  }
